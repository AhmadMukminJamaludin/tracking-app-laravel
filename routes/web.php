...
Route::middleware('role:admin|customerservice|kabaganalis|staffanalis|direktur|petugasslik')->group(function () {
    ...
    Route::get('/pengajuan-kredit/{id}/show', [App\Http\Controllers\PengajuanKreditController::class, 'show'])->name('pengajuan-kredit.show');
